...
namespace Renderer::Vulkan {
	...
	struct FrameBuffer {
		...
		FrameBuffer Create(const Core::Vulkan::VulkanContext& context, vk::RenderPass renderPass, vk::ImageView colorView, vk::ImageView depthView, uint32_t width, uint32_t height);
		void Destroy(Core::Vulkan::VulkanContext& context);
	};
}