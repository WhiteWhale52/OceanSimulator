...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "12.3.1"
  WORKING_DIRECTORY "C:/Users/moham/Documents/GitHub/Fluid_Simulator/external/VkFFT/glslang-main"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 12.3.1")
    return()
  endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/moham/Documents/GitHub/Fluid_Simulator/external/VkFFT/glslang-main'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/moham/Documents/GitHub/Fluid_Simulator/external/VkFFT/glslang-main'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
